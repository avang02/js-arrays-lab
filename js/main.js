...
const foods = ['Hamburger', 'Chow Mein', 'Noodles'];
...
// foods.push('soup');  -> Debugging for 'soup' in foods array
// console.log(foods);  -> Debugging to see the list of foods to see if 'soup' is in.
let hasSoup = false;
hasSoup = isSoup('soup');
function isSoup(soup) {
  soup = soup.toLowerCase();
